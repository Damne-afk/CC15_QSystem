...
"}")
        ...
        self.page_appointments = QStackedWidget()
        ...
        # APPOINTMENTS_for_Students | START
        
        # APPOINTMENTS_for_Students | END

        # APPOINTMENTS_for_Faculty | START
        
        # APPOINTMENTS_for_Faculty | END
        ...
        # SPECIAL_SERVICES_SUB_PAGES | START

        # SPECIAL_SERVICES_SUB_PAGES | END
