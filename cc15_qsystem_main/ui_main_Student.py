...
"}")
        ...
        self.label_6_appt = QLabel(self.page_appointments)
        self.label_6_appt.setObjectName(u"label_6_appt")
        font5 = QFont()
        font5.setFamily(u"Segoe UI")
        font5.setPointSize(40)
        self.label_6_appt.setFont(font5)
        self.label_6_appt.setStyleSheet(u"")
        self.label_6_appt.setAlignment(Qt.AlignCenter)

        self.verticalLayout_10_appt.addWidget(self.label_6_appt)

        self.label_appt = QLabel(self.page_appointments)
        self.label_appt.setObjectName(u"label_appt")
        font6 = QFont()
        font6.setFamily(u"Segoe UI")
        font6.setPointSize(14)
        self.label_appt.setFont(font6)
        self.label_appt.setAlignment(Qt.AlignCenter)

        self.verticalLayout_10_appt.addWidget(self.label_appt)

        self.label_7_appt = QLabel(self.page_appointments)
        self.label_7_appt.setObjectName(u"label_7_appt")
        font7 = QFont()
        font7.setFamily(u"Segoe UI")
        font7.setPointSize(15)
        self.label_7_appt.setFont(font7)
        self.label_7_appt.setAlignment(Qt.AlignCenter)

        self.verticalLayout_10_appt.addWidget(self.label_7_appt)
        # APPOINTMENTS_PAGE | ~END~

        # SPECIAL_SERVICES_PAGE | ~START~
        ...
        self.label_6_specserv = QLabel(self.page_special_services)
        self.label_6_specserv.setObjectName(u"label_6_specserv")
        font5 = QFont()
        font5.setFamily(u"Segoe UI")
        font5.setPointSize(40)
        self.label_6_specserv.setFont(font5)
        self.label_6_specserv.setStyleSheet(u"")
        self.label_6_specserv.setAlignment(Qt.AlignCenter)

        self.verticalLayout_10_appt.addWidget(self.label_6_specserv)

        self.label_specserv = QLabel(self.page_appointments)
        self.label_specserv.setObjectName(u"label_specserv")
        font6 = QFont()
        font6.setFamily(u"Segoe UI")
        font6.setPointSize(14)
        self.label_specserv.setFont(font6)
        self.label_specserv.setAlignment(Qt.AlignCenter)

        self.verticalLayout_10_appt.addWidget(self.label_specserv)

        self.label_7_specserv = QLabel(self.page_special_services)
        self.label_7_specserv.setObjectName(u"label_7_specserv")
        font7 = QFont()
        font7.setFamily(u"Segoe UI")
        font7.setPointSize(15)
        self.label_7_specserv.setFont(font7)
        self.label_7_specserv.setAlignment(Qt.AlignCenter)

        self.verticalLayout_10_appt.addWidget(self.label_7_specserv)
        # SPECIAL_SERVICES_PAGE | ~END~
